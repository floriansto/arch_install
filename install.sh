...
user_pkg=(ctags feh file-roller firefox gimp gparted gpicview gvfs-mtp gvfs-gphoto2 libreoffice lm_sensors octave qpdfview speedcrunch thunar thunar-volman thunar-archive-plugin thunderbird vivaldi vlc zip)
